    ...
    for(var i=0; i<loadedShapes.length; i++) {
        ...
        borderGeometry = null;
            ...
            if (loadedShapes[i].type === "BoxGeometry") {
                ...
                newPyramid(loadedScales[i].x, loadedScales[i].y, loadedScales[i].z, loadedShapes[i].positionX, loadedShapes[i].positionY, loadedShapes[i].positionZ, convertColor(loadedShapes[i].r, loadedShapes[i].g, loadedShapes[i].b) , 0xffffff)
                ...
                newRing(loadedScales[i].x, loadedScales[i].y, loadedScales[i].z, loadedShapes[i].positionX, loadedShapes[i].positionY, loadedShapes[i].positionZ, convertColor(loadedShapes[i].r, loadedShapes[i].g, loadedShapes[i].b) , 0xffffff)
