    ...
    for(var i=0; i<loadedShapes.length; i++) {
        ...
        borderGeometry = null;
            ...
            if (loadedShapes[i].type === "BoxGeometry") {
                ...
                newPyramid(loadedScales[i][0], loadedScales[i][1], loadedScales[i][2], loadedShapes[i].positionX, loadedShapes[i].positionY, loadedShapes[i].positionZ, convertColor(loadedShapes[i].r, loadedShapes[i].g, loadedShapes[i].b) , 0xffffff)
